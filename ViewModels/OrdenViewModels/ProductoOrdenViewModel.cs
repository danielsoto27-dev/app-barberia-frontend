...
namespace AppGestorVentas.ViewModels.OrdenViewModels
{
    ...
    public partial class ProductoOrdenViewModel : ObservableObject, IQueryAttributable
    {
        ...
        [ObservableProperty] private string sIdProductoLocal = string.Empty;

        // 1. Buscador principal (platillos/bebidas)
        [ObservableProperty] private string sBusquedaPrincipal = string.Empty;

        // Resultados de la búsqueda principal
        [ObservableProperty] private ObservableCollection<Producto> lstResultadosProductos = new();

        // 2. Producto seleccionado (solo 1)
        [ObservableProperty] private Producto? oProductoSeleccionado;

        // La variante seleccionada
        [ObservableProperty] private Variante? varianteSeleccionada;

        // 3. Buscador de extras
        [ObservableProperty] private string sBusquedaExtras = string.Empty;

        // Resultados de búsqueda de extras
        [ObservableProperty] private ObservableCollection<Producto> lstResultadosExtras = new();

        // 4. Extras seleccionados
        [ObservableProperty] private ObservableCollection<Producto> lstExtrasSeleccionados = new();

        // 5. Indicaciones
        [ObservableProperty] private string sIndicaciones = string.Empty;

        [ObservableProperty] private bool bNoHayUnoProductoSeleccionado = true;

        [ObservableProperty] private int iCantidad = 1;
